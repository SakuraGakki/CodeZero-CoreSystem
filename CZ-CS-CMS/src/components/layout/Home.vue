    ...
    <div class="app-wrapper" :class="{hideSidebar:!state.sidebar.opened,hoverSideBar:state.sidebar.minOpen}">
        ...
        <div class="side-wrapper" :class="{hover:!state.sidebar.minOpened,light:theme=='light'}">
            ...
            <div style="height:50px;" class="logo-box">
                ...
                <img src="https://file.iviewui.com/dist/76ecb6e76d2c438065f90cd7f8fa7371.png" alt="" height="40"
                     width="40"
        ...
        <div class="main-wrapper">
            ...
            <t-header>
                ...
                <Dropdown class="userBox" slot='right'>
                    <i class="icon iconfont icon-mine_fill" style="font-size:32px"></i>
        ...
        <Modal v-model="modalUser" width="360">
            ...
            <div style="text-align:center">
                <Form ref="formValidate" :model="formValidate" :rules="ruleValidate">
                    <Form-item prop="check_password">
                        <Input v-model="formValidate.check_password" type="password" icon="ios-locked-outline"
                               placeholder="请输入..."
            ...
            <div slot="footer">
                <Button type="info" size="large" long :loading="modal_loading" @click="checkUser('formValidate')">确定
                </Button>
            </div>
        </Modal>
    </div>
